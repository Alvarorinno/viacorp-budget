...
// Mes anterior al actual (0-based). Julio anterior = mínimo editable para director.
// Ejemplo: hoy = Agosto (7) → minEditableIdx = 6 (Julio). Junio (5) y antes = bloqueado.
const currentMonthIdx = new Date().getMonth();
const minEditableIdx  = currentMonthIdx - 1; // mes anterior inclusive es editable

const isDirectorMonthLocked = (mes_evento: string | null | undefined): boolean => {
